...
from data.pet import get_pets_datasets
...
def get_datasets(dataset_name, train_transform, test_transform, args):
    ...
    # -----
    # simgcd-but this will causes the error when we set num_workers bigger than 0 in DDP
    # -----
    ...
    # -----
    # we remedy this by directly using the dict
    # -----
    # for dataset_name, dataset in datasets.items():
    #     if dataset is not None:
    #         dataset.target_transform = target_transform_dict
